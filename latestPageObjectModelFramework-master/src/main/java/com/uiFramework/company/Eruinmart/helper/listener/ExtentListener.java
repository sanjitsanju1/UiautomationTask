package com.uiFramework.company.Eruinmart.helper.listener;
...
public class ExtentListener implements ITestListener{
    private Logger log = com.uiFramework.company.Eruinmart.helper.logger.LoggerHelper.getLogger(ExtentListener.class);
